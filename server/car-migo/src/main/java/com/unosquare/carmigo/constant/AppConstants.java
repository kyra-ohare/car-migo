...
public final class AppConstants {
  ...
  public static final String VALID_PASSWORD_MESSAGE = "must be between 8 and 20 characters and at least"
      + " 2 of the following: alphanumeric characters and/or one special character ( " + SPECIAL_CHARACTERS + " )"
      + " and/or one capital letter";
