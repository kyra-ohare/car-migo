...
public class PassengerService
{
    ...
    public GetPassengerDTO createPassenger(final int id, final CreatePassengerDTO createPassengerDTO)
    {
        ...
        return modelMapper.map(passengerRepository.save(passenger), GetPassengerDTO.class);
    }
