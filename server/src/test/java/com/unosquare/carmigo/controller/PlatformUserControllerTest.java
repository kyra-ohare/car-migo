...
public class PlatformUserControllerTest
{
    ...
    final private UsernamePasswordAuthenticationToken user = new UsernamePasswordAuthenticationToken(
            null, null, null);
    ...
    {
        try {
            when(platformUserServiceMock.getPlatformUserById(anyInt(), any(Authentication.class)))
    ...
    public void patch_PlatformUser_Returns_HttpStatus_BadRequest() throws Exception
    {
        mockMvc.perform(patch(API_LEADING + "1")
                ...
                .andExpect(status().isBadRequest());
        verify(platformUserServiceMock, times(0))
                .patchPlatformUser(anyInt(), any(JsonPatch.class), any(Authentication.class));
    }
    ...
    {
        try {
            when(platformUserServiceMock.patchPlatformUser(anyInt(), any(JsonPatch.class), any(Authentication.class)))
                    .thenThrow(AuthenticationException.class);
            mockMvc.perform(patch(API_LEADING + "1")
                    .principal(user)
                    .contentType("application/json-patch+json")
    ...
    public void delete_PlatformUser_Throws_AuthenticationException()
    {
        try {
            doThrow(AuthenticationException.class)
                    .when(platformUserServiceMock).deletePlatformUserById(anyInt(), any(Authentication.class));
            mockMvc.perform(delete(API_LEADING + "1")
                            .principal(user))
                    .andExpect(status().isNoContent());
        } catch (final Exception ex) {
    ...
    {
        try {
            when(platformUserServiceMock.getDriverById(anyInt(), any(Authentication.class)))
                    .thenThrow(AuthenticationException.class);
    ...
    {
        try {
            when(platformUserServiceMock.createDriver(anyInt(), any(CreateDriverDTO.class), any(Authentication.class)))
                    .thenThrow(AuthenticationException.class);
    ...
    public void delete_Driver_Throws_AuthenticationException()
    {
        try {
            doThrow(AuthenticationException.class)
                    .when(platformUserServiceMock).deleteDriverById(anyInt(), any(Authentication.class));
    ...
    {
        try {
            when(platformUserServiceMock.getPassengerById(anyInt(), any(Authentication.class)))
                    .thenThrow(AuthenticationException.class);
    ...
    {
        try {
            when(platformUserServiceMock.createPassenger(anyInt(), any(Authentication.class)))
                    .thenThrow(AuthenticationException.class);
    ...
    public void delete_Passenger_Throws_AuthenticationException()
    {
        try {
            doThrow(AuthenticationException.class)
                    .when(platformUserServiceMock).deletePassengerById(anyInt(), any(Authentication.class));
