...
public class PlatformUserControllerTest {
  ...
  public void setUp() {
    ...
    mockMvc = MockMvcBuilders.standaloneSetup(new PlatformUserController(modelMapperMock, platformUserServiceMock))
        .build();
  }
  ...
  public void get_PlatformUser_By_Id_Returns_HttpStatus_Ok() throws Exception {
    ...
    when(modelMapperMock.map(grabPlatformUserDTOFixture, PlatformUserViewModel.class)).thenReturn(
        platformUserViewModelFixture);
  ...
  public void get_Driver_By_Id_Returns_HttpStatus_Ok() throws Exception {
    ...
    when(modelMapperMock.map(grabDriverDTOFixture, DriverViewModel.class)).thenReturn(driverViewModelFixture);
  ...
  public void get_Passenger_By_Id_Returns_HttpStatus_Ok() throws Exception {
    ...
    when(modelMapperMock.map(grabPassengerDTOFixture, PassengerViewModel.class)).thenReturn(passengerViewModelFixture);
