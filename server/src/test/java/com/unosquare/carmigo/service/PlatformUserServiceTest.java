...
//        patch, authentication(platformUserFixture.getEmail(), ACTIVE));
//
//    assertThat(grabPlatformUserDTO.getFirstName()).isEqualTo(grabPlatformUserDTOFixture.getFirstName());
//    assertThat(grabPlatformUserDTO.getLastName()).isEqualTo(grabPlatformUserDTOFixture.getLastName());
...
//      when(platformUserRepositoryMock.findById(anyInt())).thenReturn(Optional.of(platformUserFixture));
//      final JsonPatch patch = PatchUtility.jsonPatch(PATCH_PLATFORM_USER_VALID_JSON);
//      platformUserService.patchPlatformUser(platformUserFixture.getId(), patch,
//          authentication(platformUserFixture.getEmail(), STAGED));
...
//        authentication(driverFixture.getPlatformUser().getEmail(), ACTIVE));
//
...
//    try {
//      when(driverRepositoryMock.findById(anyInt())).thenReturn(Optional.of(driverFixture));
//      platformUserService.getDriverById(anyInt(), authentication(driverFixture.getPlatformUser().getEmail(), STAGED));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
//    verify(driverRepositoryMock).findById(anyInt());
...
//        authentication(platformUserFixture.getEmail(), ACTIVE));
//
//    assertThat(grabDriverDTO.getLicenseNumber()).isEqualTo(grabDriverDTOFixture.getLicenseNumber());
//    assertThat(grabDriverDTO.getPlatformUser()).isEqualTo(grabDriverDTOFixture.getPlatformUser());
...
//      when(modelMapperMock.map(createDriverDTOFixture, Driver.class)).thenReturn(spyDriver);
//      when(entityManagerMock.getReference(eq(PlatformUser.class), anyInt())).thenReturn(platformUserFixture);
//      platformUserService.createDriver(1, createDriverDTOFixture,
//          authentication(platformUserFixture.getEmail(), STAGED));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
...
//        authentication(passengerFixture.getPlatformUser().getEmail(), ACTIVE));
//
...
//    try {
//      when(passengerRepositoryMock.findById(anyInt())).thenReturn(Optional.of(passengerFixture));
//      platformUserService.getPassengerById(anyInt(),
//          authentication(passengerFixture.getPlatformUser().getEmail(), STAGED));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
//    verify(passengerRepositoryMock).findById(anyInt());
...
//    when(entityManagerMock.getReference(eq(PlatformUser.class), anyInt())).thenReturn(platformUserFixture);
//
//    platformUserService.createPassenger(1, authentication(platformUserFixture.getEmail(), ACTIVE));
...
//      when(entityManagerMock.getReference(eq(PlatformUser.class), anyInt())).thenReturn(platformUserFixture);
//
//      platformUserService.createPassenger(1, authentication(platformUserFixture.getEmail(), STAGED));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
...
//        authentication(platformUserFixture.getEmail(), userStatus));
//
...
//    try {
//      when(platformUserRepositoryMock.findById(anyInt())).thenReturn(Optional.of(platformUserFixture));
//      platformUserService.getPlatformUserById(anyInt(), authentication(platformUserFixture.getEmail(), userStatus));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
//    verify(platformUserRepositoryMock).findById(anyInt());
...
//    try {
//      when(platformUserRepositoryMock.findById(anyInt())).thenReturn(Optional.of(platformUserFixture));
//      platformUserService.deletePlatformUserById(anyInt(), authentication(platformUserFixture.getEmail(), userStatus));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
...
//          authentication(driverFixture.getPlatformUser().getEmail(), userStatus));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
...
//          authentication(passengerFixture.getPlatformUser().getEmail(), userStatus));
//    } catch (final Exception ex) {
//      assertEquals(NO_PERMISSIONS, ex.getMessage());
//    }
